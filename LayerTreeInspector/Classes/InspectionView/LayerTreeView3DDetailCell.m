...
@interface LayerTreeView3DDetailCell ()
{
...
@implementation LayerTreeView3DDetailCell
...
- (void)updateWithNode:(LayerTreeBaseNode *)node{
    ...
    self.detailLabel.text = [NSString stringWithFormat:@"View:%@",node.LayerTreeNodeView==nil?@"":node.LayerTreeNodeView];
}
...
- (NSString *)getHierarchyAtNode:(LayerTreeBaseNode *)node{
    if (node.fatherNode == nil) {
        ...
        [_hierarchys insertObject:NSStringFromClass(node.LayerTreeNodeView.class) atIndex:0];
